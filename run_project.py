...
def resolve_npm_command() -> str:
    """Resolve the npm executable on Windows and other platforms."""
    if os.name == "nt":
...
def main():
    ...
    try:
        ...
        print("=" * 50)
        print("Backend : https://stocklens-production-89a6.up.railway.app")
        print("Frontend: http://localhost:3000")
        print("Docs    : https://stocklens-production-89a6.up.railway.app/api/docs")
        print("=" * 50)
