...
def test_feature_extraction():
    ...
    from backend.app.services.ml.narrative_engine import NarrativeEngine
...
def test_narrative_generation():
    ...
    try:
        from backend.app.services.ml.narrative_engine import get_narrative_engine
        from backend.app.services.ml.price_predictor import get_prediction_with_analysis
