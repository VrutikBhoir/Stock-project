...
# ----------------------------------------
# DASHBOARD-LEVEL MARKET RISK AGGREGATION
# ----------------------------------------

def predict_market_risk(signals):
    """
    Aggregate market risk from stock-wise signals.
    Used ONLY by dashboard metrics API.
    """
    ...
    risk_score = max(0, min(5, bearish - bullish))
