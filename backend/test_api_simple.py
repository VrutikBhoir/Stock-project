...
def test_api():
    ...
    try:
        health_response = requests.get("https://stocklens-production-89a6.up.railway.app/api/market-reasoning/health")
    ...
    try:
        response = requests.post(
            "https://stocklens-production-89a6.up.railway.app/api/market-reasoning/explain",
            json=test_data,
